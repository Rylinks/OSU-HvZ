...
<?php
	if($_POST['submit'] == 'Submit') 
	{
		...
		$end = "?> ";
		fwrite($fh, $start);
		$stringData = "\$username = '" . $_POST['twitterusername1'] . "';\n";
		fwrite($fh, $stringData);
		$stringData = "\$password = '" . $_POST['twitterpassword1'] . "';\n";
		fwrite($fh, $stringData);
		fwrite($fh, $end);
		fclose($fh);
...
Twitter username:
<input type="text" name="twitterusername1">
<br />
Twitter password:
<input type="password" name="twitterpassword1">
<br />
